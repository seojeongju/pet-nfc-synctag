...
export function AdminSidebarNav() {
  ...
  return (
    <aside className="hidden lg:flex w-full shrink-0 flex-col border-b border-slate-100 bg-white/90 shadow-lg shadow-slate-100/50 backdrop-blur-md lg:z-auto lg:w-auto lg:max-h-screen lg:sticky lg:top-0 lg:min-h-screen lg:border-b-0 lg:border-r">
