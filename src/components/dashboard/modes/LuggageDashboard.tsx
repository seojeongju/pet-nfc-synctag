      ...
      >
          ...
          <div className="space-y-1">
            ...
            {tenantId && (
              <div className="inline-flex flex-col gap-1 rounded-xl border border-slate-100 bg-slate-50 px-3 py-2">
                <p className="text-[10px] font-black text-slate-700">조직 플랜 배지</p>
                {tenantUsage ? (
        ...
        <motion.section variants={itemVariants} className="space-y-4">
           <div className="flex items-center justify-between px-2">
              ...
              <a href={`/dashboard/pets${kindQs}`} className="text-[10px] font-black text-slate-600 uppercase tracking-widest hover:underline transition-all">View All</a>
           </div>
