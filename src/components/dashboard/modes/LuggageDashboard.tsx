...
export default function LuggageDashboard({
  ...
  return (
    <div className="relative min-h-0 w-full min-w-0 overflow-x-hidden bg-[#F8FAFC] pb-6 font-outfit">
      <div className="pointer-events-none absolute left-0 top-0 h-[300px] w-full bg-gradient-to-b from-slate-500/10 to-transparent" />
          ...
          <Card className="border-none rounded-[40px] bg-slate-900 text-white overflow-hidden relative shadow-[0_32px_64px_-12px_rgba(0,0,0,0.2)]">
            ...
            <div className="p-8 space-y-5 relative z-10">
              ...
              <a
                ...
                className={cn(
                  buttonVariants({}),
                  "rounded-2xl font-black bg-slate-500 text-white hover:bg-slate-600 px-6 h-11 text-xs shadow-lg shadow-slate-500/20 flex items-center justify-center transition-all active:scale-95"
                )}
              >
                상세 리포트 보기
              </a>
