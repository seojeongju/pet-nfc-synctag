                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm font-bold text-slate-400 leading-relaxed">Safari 브라우저 하단의 <span className="text-slate-800">[공유]</span> 버튼을 터치하세요.</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm font-bold text-slate-400 leading-relaxed">메뉴 목록을 올려 <span className="text-slate-800">&apos;홈 화면에 추가&apos;</span>를 선택하세요.</p>
